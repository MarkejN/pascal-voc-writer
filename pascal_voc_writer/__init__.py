...
class Writer:
    def __init__(self, path, lastModifiedBy="Unknown", width, height, depth=3, database='Unknown', segmented=0):
    ...
    def addObject(self, name, verification, xmin, ymin, xmax, ymax, pose='Unspecified', truncated=0, difficult=0):
